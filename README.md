...
1. Pilot thoughts with 12 to 20 teammates.
...
The 10 archetype illustrations are recolored Storyset assets supplied for this project. The site uses optimized WebP copies in `assets/archetypes/`; the original supplied PNGs are kept in `source-assets/archetypes/` in the downloadable project bundle.
